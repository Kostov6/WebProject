...
*/
		if (request.getUserPrincipal() == null) {
			...
			writer.append("<!DOCTYPE html>\r\n" + "<html>\r\n" + "<body>\r\n" + "<h2>Login</h2>\r\n"
					...
					+ "		<input type=\"button\" style=\"display: inline;\" value=\"Go to GitHub!\" onclick=\"window.location.href='https://github.com/login/oauth/authorize?scope=user:email&client_id=099b3b26927004bc8273'\" />\r\n"
