...
public class UserDatabase extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
	    	...
	    	ResultSet res2=statement.executeQuery("select * from user_roles;");
	    	
	    	while(res1.next())
	    	{
	    		res2.next();
	    		writer.println(res1.getString("user_name") + " " + res1.getString("user_pass") + " | Confirm user: "+
	    				res2.getString("user_name") + " Role: " + res2.getString("role_name"));
	    	}
